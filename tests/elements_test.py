...
class TestElements:
    ...
    class TestWebTable:
        ...
        def test_web_table_search_person(self, driver):
            ...
            assert keyword in table_result, "The person was not found in the table"
    ...
    class TestUploadAndDownload:
        ...
        def test_upload_file(self, driver):
            ...
            file_nme, result = upload_page.upload_file()
            assert file_nme == result, "The file has not been uploaded"
